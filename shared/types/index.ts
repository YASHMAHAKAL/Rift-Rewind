...
export interface Match {
  ...
  playerParticipantId: number; // Which participant is the target player
}
...
export interface Participant {
  ...
  role: string;
  lane: string;
  // Timeline data (optional, if available)
...
export interface HeroSummary {
  narrative: string; // 100-150 word story
  keyHighlights: string[];
  standoutMoments: string[];
  growthAreas: string[];
  evidenceMatchIds: string[]; // Source matches
}
...
export interface RoastInsight {
  roast: string; // Playful critique (50-75 words)
...
export interface HiddenGem {
  title: string;
  description: string;
  percentile?: number; // e.g., "top 5% of players"
  evidenceMatchIds: string[];
}

// ============================================================================
// Match Fragment Types (for RAG)
// ============================================================================
...
export interface MatchFragment {
  ...
  timeRange: string; // e.g., "0-15min"
  description: string; // Human-readable summary
  stats: Record<string, number>;
  outcome: 'positive' | 'neutral' | 'negative';
  embedding?: number[]; // Vector embedding (1536 dims for Titan)
  relevanceScore?: number; // Populated during retrieval
}
...
export interface SocialShareCard {
  ...
  imageUrl: string; // Generated PNG/WebM
  shareText: string;
  generatedAt: string;
}
